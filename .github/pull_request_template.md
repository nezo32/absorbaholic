<!-- The PR title becomes a release-notes line: write it as an imperative sentence ("Add Obsidian trait"). -->
...
<!-- How you checked it: tests added, `./gradlew build` (JUnit + server GameTests), in-game steps. -->

## Checklist

- [ ] Branch is named `<type>/<kebab-name>` and targets `main`
- [ ] Local checks pass (`cd fabric && ./gradlew build`, and `./gradlew build -Pmc=26.2` for version-specific code)
